-- Simple messages table creation - FIXED VERSION
-- This script creates the messages table without complex sample data
...
-- 7. Insert simple sample messages for testing
...
SELECT 
  ...
  END
FROM campaigns c
CROSS JOIN generate_series(1, 2) as msg_count
