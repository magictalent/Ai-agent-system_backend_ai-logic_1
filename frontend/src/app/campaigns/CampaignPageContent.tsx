...
// ... (your CampaignDetails component here, unchanged)
...
export default function CampaignsPageContent() {
  ...
  // ✅ All the code you already have here:
  // useState, useAuth, useSearchParams, router, fetchData, handlers, filters, JSX, etc.
}
